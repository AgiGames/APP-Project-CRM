...
/*
    ...
    functions in the process of implementing (backend):
    -> adminHomePage()
...
public class UserInputs {
    ...
    */
    public void adminHomePage() {
        ...
        System.out.println("Welcome admin, " + currentAdminName);
        int choice = 0;
        while(choice != 7) {
            ...
            switch (choice) {
                case 1:
                    DataVisualization.displayStudents(currentAdminName);
                    break;
                case 2:
                    registerStudent();
                    break;
                case 3:
                    ...
                    break;
                case 5:
                    DataVisualization.displayStudentFolder(currentAdminName);
                case 7:
                    break;
                default:
    ...
    private static void registerStudent() {
        ...
        AgiDB studentDB = new AgiDB(CRM.localDatabasePath, currentAdminName + "\\students\\" + nameOfStudent.toUpperCase() + "-" + registrationNumberOfStudent);
